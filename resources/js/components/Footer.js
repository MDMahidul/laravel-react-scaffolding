        ...
        return (
            <Fragment>
                    ...
                    <Container className="container">
                        <Row>
                            ...
                            <Col sm={6} lg={3} md={3} >
                                ...
                                <p className="des-text">  <FontAwesomeIcon icon={faPhone} /> +8801710611980</p>
                                <p className="des-text">  <FontAwesomeIcon icon={faEnvelope} /> mmbmahidul007@.com</p>
                            </Col>
                            <Col sm={6} lg={3} md={3} >
                                <h3 className="title-text">Information</h3>
                                <hr/>
                                <a className="footer-link" target="_blank" href="http://rabbil.com/">About Mahidul </a><br/>
                            </Col>
                            <Col sm={6} lg={3} md={3} >
                ...
                <Container fluid={true} className="text-white m-0 text-center p-3 custom-bg">
                    <p className="credit-text my-2 ">All Rights Reserved By MD. Mahidul Islam © 2020-2021</p>
                </Container>
            </Fragment>
        );
    }
